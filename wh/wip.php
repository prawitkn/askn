...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
        ...
        <label class="box-title">Work In Process List</label>
		<a href="<?=$rootPage;?>_add.php?wipNo=" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Work In Process</a>
        ...
        <div class="box-tools pull-right">
          ...
          <?php
				$sql = "
					SELECT COUNT(hdr.wipNo) AS countTotal
					FROM `wip` hdr 
					...
					if(isset($_GET['search_word']) and isset($_GET['search_word'])){
						...
						$sql .= "AND (hdr.wipNo like '%".$_GET['search_word']."%') ";
					}
        ...
        <div class="box-body">
				...
				<div class="col-md-6">					
						<form id="form1" action="<?=$rootPage;?>.php" method="get" class="form" novalidate>
							<div class="form-group">
								<label for="search_word">Work In Process No. search key word.</label>
           ...
           <?php
                $sql = "
				SELECT hdr.`wipNo`, hdr.`wipDate`, hdr.`remark`, hdr.`statusCode`, hdr.`createTime`, hdr.`createByID`
                ...
                <tr>
					...
					<td>					
						<a class="btn btn-info " name="btn_row_search" 
							href="<?=$rootPage;?>_view.php?wipNo=<?=$row['wipNo'];?>" target="_blank" 
							data-toggle="tooltip" title="Search"><i class="glyphicon glyphicon-search"></i></a>
						<a class="btn btn-success" name="btn_row_edit" 
							<?php if($row['statusCode']=='B'){ ?>href="<?=$rootPage;?>_add.php?wipNo=<?=$row['wipNo']?>" <?php }else{ ?> disabled <?php } ?>
