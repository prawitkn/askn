...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
        ...
        <h3 class="box-title">Add Customer Return Receive No. : <?=$rcNo;?></h3>
        ...
        <div class="box-body">			
            <div class="row">
                ...
                <div class="col-md-12">   
					<div class="row">
						<div class="col-md-3">
							<label for="refNo" >Customer Return No.</label>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Search Customer Return No.</h4>
      </div>
      <div class="modal-body">
        <div class="form-horizontal">
			<div class="form-group">	
				<label for="year_month" class="control-label col-md-2">CR NO.</label>
				<div class="col-md-4">
