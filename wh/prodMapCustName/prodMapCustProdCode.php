...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
       ...
       Product Mapping Customer's Product Code
        <small>Product Mapping Customer's Product Code</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Product Mapping Customer's Product Code List</a></li>
      </ol>
    </section>
...
<!-- To allow only admin to access the content -->      
    <div class="box box-primary">
		...
		<label class="box-title">Product Mapping Customer's Product Code List</label>
			<a href="<?=$rootPage;?>_add.php" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Product Mapping Customer's Product Code</a>
