...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
		Product Sales Order Pending
        <small>Product Sales Order Pending</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Main</a></li>
        <li class="active">Product Sales Order Pending</li>
      </ol>
    </section>
          ...
          <div class="box">
            <div class="box-header with-border">              
			  <form id="frmPeriod" method="get">
				<label class="box-title">Product Sales Order Pending</label>	
				...
				<?php		
					$url="order_product_pendeing.php";
							...
							$sql = "
								...
								GROUP BY p.`id`, p.`code`, p.`prodGroup`, p.`prodName`, p.`prodNameNew`, p.`photo`								
									";					
