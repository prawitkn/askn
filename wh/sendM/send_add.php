...
$sql = "SELECT hdr.`ppNo`, hdr.`pickNo`, hdr.`prepareDate`, hdr.`remark`, hdr.`statusCode`, hdr.`createTime`, hdr.`createByID`
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">			
            <div class="row">
                ...
                <div class="col-md-12">   
					<div class="row">
						<div class="col-md-3">
							<label for="pickNo" >Picking No.</label>
							<div class="form-group row">
								<div class="col-md-9">
									<input type="text" name="pickNo" class="form-control" <?php echo ($ppNo==''?'':' value="'.$pickNo.'" disabled '); ?>  />
								</div>
								<div class="col-md-3">
									<a href="#" name="btnSdNo" class="btn btn-primary" <?php echo ($ppNo==''?'':' disabled '); ?> ><i class="glyphicon glyphicon-search" ></i></a>								
								</div>
							</div>
							<!--from group-->							
                        </div>		
		...
		<div class="row">
			<div class="col-md-3">		
				...
				<input type="text" id="prepareDate" name="prepareDate" class="form-control datepicker" data-smk-msg="Require Order Date." required <?php echo ($ppNo==''?'':' disabled '); ?> >
				</div>
				<!--from group-->				
			</div>
			<!--col-md-->
			<div class="col-md-6">	
				<div class="from-group">
					...
					<input type="text" id="remark" name="remark" value="<?=$hdr['remark'];?>" class="form-control" <?php echo ($ppNo==''?'':' disabled '); ?> >
				</div>
				<!--from group-->
			</div>
			<!--col-md-->
		...
		<!--row-->
		<div class="row" <?php echo ($ppNo==''?'':' style="display: none;" '); ?>>
			<div class="col-md-12">					
		...
		<!--row-->
			...
			<?php
					$sql = "SELECT count(*) as countTotal FROM prepare_detail WHERE ppNo=:ppNo 
								";						
					$stmt = $pdo->prepare($sql);	
			...
			<div class="row" <?php echo ($ppNo==''?' style="display: none;" ':''); ?> >
				...
				<div class="box-body">					
					...
					<?php
						...
						, itm.barcode, itm.grade, itm.issueDate, itm.qty
