           ...
           <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="clearfix visible-sm-block"></div>
             ...
             <div class="col-md-3 col-sm-6 col-xs-12">
               <div class="info-box">
                   ...
                   <div class="info-box-content"> 
                       <?php
                        $sql_box1 ="SELECT SUM(forecast) as sumForecast, 
					   ...
					   <span class="info-box-number"><?= number_format($count_box1['sumForecast'], 0, '.', ','); ?> Baht</span>
                       <span class="info-box-number"><?= number_format(($count_box1['sumActual']/$count_box1['sumForecast'])*100, 2, '.', ','); ?>%</span>
                   </div><!-- /.info-box-content -->
               </div> <!-- /.info-box -->
            </div> <!-- /.col --> 
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
               <div class="info-box">
                   ...
                   <div class="info-box-content"> 
                       <?php
                        $sql_box1 ="SELECT SUM(forecast) as sumForecast, sum(actual) as sumActual
									FROM t_sales_monthly
									WHERE year=".$year."	
									";
                        $result_box1 = mysqli_query($link, $sql_box1);
