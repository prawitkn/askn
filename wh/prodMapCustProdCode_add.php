  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <ol class="breadcrumb">
		...
		<li><a href="#"><i class="glyphicon glyphicon-edit"></i>Add Customer's Product Code Mapping</a></li>
      </ol>
    </section>
    ...
    <div class="box box-primary">
        ...
        <h3 class="box-title">Add Customer's Product Code Mapping</h3>
            ...
            <div class="row">                
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="row">
								<div class="col-md-10">
									<input type="hidden" name="custId" id="custId" class="form-control" value="" />
									<input type="text" name="custName" id="custName" class="form-control" value="" data-smk-msg="Require Customer" required  />
								</div><!--col-md-12-->
								<div class="col-md-2">
                        ...
                        <div class="form-group">
							...
							<div class="form-group">
								...
								<input id="custProdCode" type="text" class="form-control" name="custProdCode" value=""  data-smk-msg="Require Customer Product Code."required>
							</div>
                        </div>                       
						...
						<div class="form-group row">
							<div class="col-md-9">
								<textarea id="custProdDesc" name="custProdDesc" class="form-control" data-smk-msg="Require Customer Product Description."required></textarea>
							</div>
						</div>
						<!--from group-->
						<!--<div class="form-group">
