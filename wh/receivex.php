...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <a href="receive_add.php?doNo=" class="btn btn-google">Add Receive</a>
        ...
        <div class="box-tools pull-right">
          ...
          <?php
				...
				if(isset($_GET['search_word']) and isset($_GET['search_word'])){
					...
					$sqlSearch = "and (rc.`refNo` like '%".$_GET['search_word']."%' OR  rc.`remark` like '%".$_GET['search_word']."%') ";
				}
				$sqlCond = "";
				
                $sql = "
				SELECT COUNT(rc.rcNo) AS countTotal
				FROM `receive` rc 
				WHERE 1 
					".$sqlSearch." 
					".$sqlCond." 
