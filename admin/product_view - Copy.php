          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
				<?php				
					$id = $_GET['id'];
					$sql = "SELECT `id`, `prodGroup`, `prodName`, `prodNameNew`, `photo`, `prodPrice`, `prodDesc`, `appID`, `statusCode` 
							FROM `product` 
							WHERE 1
							AND id=:id 
							";
                ...
                <div class="col-md-8">
					<table>
						<tr>
							...
							<td style="font-size: large;"><?= $sm['id'].'&nbsp;&nbsp;'.$sm['prodNameNew']; ?></td>
						</tr>
						<tr>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
				<?php			
					$sql = "SELECT sm.`id`, sm.`code`, sm.`name`
				...
				<table class="table no-margin">
				  ...
				  <tr>
					...
					<td>
						 <a target="_blank" href="salesman_view.php?id=<?=$row['id'];?>" ><?= $row['name']; ?></a>
					</td>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
				<?php							
					$sql = "SELECT cm.`id`, cm.`code`, cm.`custName`
							, IFNULL(SUM(od.qty),0) as sumQty
							, IFNULL(SUM(od.netTotal),0) as sumNetTotal 
							FROM `customer` cm
 ...
 <?php 
		$sql = "SELECT
						...
						,(SELECT IFNULL(sum(tg.budget),0)/1000 FROM target_prod tg
                         	WHERE tg.month=a.id 
							AND tg.prodCode=:id AND tg.year=:yearBudget )as sumBudget
                        ,(SELECT IFNULL(sum(tg.Forecast),0)/1000 FROM target_prod tg
                         	WHERE tg.month=a.id 
							AND tg.prodCode=:id2 AND tg.year=:yearForecast )as sumForecast
						...
						LEFT JOIN `sale_detail` od on oh.soNo=od.soNo AND od.prodCode=:id3  
						WHERE 1
