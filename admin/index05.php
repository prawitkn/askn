              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
					<?php
						$sql_smc = "
									SELECT IFNULL(COUNT(*),0) AS countSM FROM `m_salesman` WHERE `isActive`='A'
									";
                ...
                <div class="box-body no-padding">
					<?php
						$sql_smm = "
									SELECT `ID`, `name`, `surname`, `photo`, `positionName`, `mobileNo` FROM `m_salesman` WHERE `isActive`='A'
									";
					...
					<?php
						...
						?>
							<li>
							  ...
							  <a class="users-list-name" href="#"><?= $row['name'].' '.$row['surname']; ?></a>
                ...
                <div class="box-footer text-center">
                  <a href="javascript:void(0)" class="uppercase">View All Sales</a>
                </div>
                <!-- /.box-footer -->
              </div>
              <!--/.box -->
...
<?php
        $sql_rpt = "SELECT 
					...
					FROM `m_salesman` a 
					left join `t_visit_customer` b on a.ID=b.salesmanID
					where 1
