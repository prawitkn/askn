	  ...
	  <div class="row">
		...
		<div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Salesman Info</h3>
			...
			<div class="box-body">
			  <div class="row">
				<?php
					$sql = "SELECT smCode FROM user WHERE userID=:s_userID LIMIT 1";
		...
		<!--/.body-->
						  ...
						  <div class="table-responsive">
							<table class="table no-margin">
							  ...
							  <tr>
								...
								<td><a href="pages/examples/invoice.html"><?php to_thai_datetime_fdt($row['createTime']); ?></a></td>
							</tr>
							<?php $row_no+=1; } ?>
							  </tbody>
							</table>
				...
				<div class="col-md-4">
				  ...
				  <div class="box box-danger">
					...
					<div class="box-body">
						<?php							
							$sql = "SELECT c.code, a.`prodCode`, IFNULL(sum(a.`qty`),0) as qty, IFNULL(sum(a.`netTotal`),0) as netTotal
									, c.`prodNameNew` as prodName
									FROM invoice_detail a
									INNER JOIN invoice_header b on a.invNo=b.invNo AND b.statusCode='P' 
										and year(b.invoiceDate)=:year ".($month<>"0"?"and month(b.invoiceDate)=:month":"")."
				  ...
				  <div class="box box-primary">
					...
					<div class="box-body">
						<?php							
							$sql = "SELECT hdr.custCode,b.code, b.custName, IFNULL(sum(hdr.`totalIncVat`),0) as total
									FROM invoice_header hdr
									INNER join customer b on hdr.custCode=b.code 
										and year(hdr.invoiceDate)=:year ".($month<>"0"?"and month(hdr.invoiceDate)=:month":"")."
...
<script src="plugins/highcharts-5.0.12/code/modules/exporting.js"></script>
 ...
 <?php
        $sql = "SELECT
						...
						, IFNULL(sum(b.totalIncVat),0)/1000 as sumActual
						FROM `month` a                        
						LEFT JOIN `invoice_header` b on month(b.invoiceDate)=a.id and b.statusCode='P' and b.smCode=:smCode3
