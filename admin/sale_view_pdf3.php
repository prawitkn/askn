...
if( isset($_GET['soNo']) ){			
			...
			if($hdr['shipByFcl']==0){}else{$shipByStr.=($shipByStr==""?"":",  ")."FCL'";}
			if($hdr['shipByRem']==""){}else{$shipByStr.=" ".$hdr['shipByRem'];}
			...
			$pdf->Cell(15, 5, 'ขอ COA');
						
			$pdf->Cell(23, 5, 'Shipping Mark : ');
			if(true or $hdr['shippingMarksFilePath']==""){				
			...
			$pdf->MultiCell(30, 0, $remStr, 'B', 0, 'L', 1);
