...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa fa-object-group"></i>
       Customer Group
        <small>Customer Group management</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Customer Group List</a></li>
      </ol>
    </section>
...
<!-- To allow only admin to access the content -->      
    <div class="box box-primary">
		...
		<label class="box-title">Customer Group List</label>
			<a href="<?=$rootPage;?>_add.php?id=" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Customer Group</a>
				...
				<div class="col-md-6">					
					<form id="form1" action="<?=$rootPage;?>.php" method="get" class="form" novalidate>
						<div class="form-group">
							<label for="search_word">Customer Group search key word.</label>
