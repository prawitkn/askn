...
?>
  ...
  <!-- Left side column. contains the logo and sidebar -->
   ...
   $sql = "SELECT h.*
	...
	FROM ".$tb." h 
	INNER JOIN product prd ON prd.id=h.prodId 
	WHERE 1
	AND h.id=".$_GET['id']." 
	";
	//echo $sql;
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
        ...
        <h3 class="box-title">Edit Product Roll Length : <?=$row['prodCode'].' / '.$row['name'];?></h3>
            ...
            <div class="row">                
					...
					<div class="col-md-6">
						...
						<div class="form-group row col-md-12">
							...
							<input id="name" type="text" class="form-control" name="name" value="<?=$row['name'];?>" data-smk-msg="Require Roll Length" required 
