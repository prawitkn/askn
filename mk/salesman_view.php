      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
				<?php							
					$sql = "SELECT c.code, IFNULL(sum(a.`qty`),0) as qty, IFNULL(sum(a.`netTotal`),0) as netTotal
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
				<?php							
					$sql = "SELECT b.code, b.custName, IFNULL(sum(hdr.`total`),0) as total
 ...
 <?php
        $sql = "SELECT
						...
						,(SELECT IFNULL(sum(tg.budget),0)/1000 FROM target_cust tg
                          	INNER JOIN customer cm1 on tg.custCode=cm1.code AND cm1.smCode=:code
                         	WHERE tg.month=a.id AND tg.year=:yearBudget)as sumBudget
                        ,(SELECT IFNULL(sum(tg.Forecast),0)/1000 FROM target_cust tg
                          	INNER JOIN customer cm1 on tg.custCode=cm1.code AND cm1.smCode=:code2
                         	WHERE tg.month=a.id AND tg.year=:yearForecast )as sumForecast
						, IFNULL(sum(b.total),0)/1000 as sumActual
						FROM `month` a                        
						LEFT JOIN `sale_header` b on month(b.saleDate)=a.id and b.statusCode='P' and b.smCode=:code3
