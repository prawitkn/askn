...
$rootPage = 'custLocation';
$tb = 'customer_location_type';
//Check user roll.
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa fa-map-pin"></i>
       Customer Location
        <small>Customer Location management</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Customer Location List</a></li>
      </ol>
    </section>
...
<!-- To allow only admin to access the content -->      
    <div class="box box-primary">
		...
		<label class="box-title">Customer Location List</label>
			<a href="<?=$rootPage;?>_add.php?id=" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Customer Location</a>
				...
				<div class="col-md-6">					
					<form id="form1" action="<?=$rootPage;?>.php" method="get" class="form" novalidate>
						<div class="form-group">
							<label for="search_word">Customer Location search key word.</label>
