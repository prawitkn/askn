						...
						if($_FILES["file"]["size"] > 0)
						{
							...
							while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
							{
								...
								if($count>1){                                  // add this line									
									$sql = "INSERT into target_prod(
									`year`, `month`, `prodCode`, `budget_qty`, `budget`, `forecast_qty`, `forecast`
									) values 
									('$year','$emapData[0]','$emapData[1]','$emapData[2]','$emapData[3]','$emapData[4]','$emapData[5]')";
