  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-edit"></i>Edit Sale Option</a></li>
      </ol>
    </section>
    ...
    <div class="box box-primary">
        ...
        <h3 class="box-title">Edit Sale Option Type</h3>
				...
				<div class="row">
					<div class="col-md-3" style="display: none;">					
	                    <div class="form-group">
	                        <label for="code">Sale Option Code</label>
	                        <input id="code" type="text" class="form-control" name="code" value="<?=$row['code'];?>" >
	                    </div>
					</div>
					<!--/.col-md-->
					...
					<div class="col-md-6">
						<div class="form-group">
	                        <label for="name">Sale Option Description</label>
