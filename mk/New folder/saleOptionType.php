...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
		<h1><i class="fa fa-sticky-note"></i>
       Sale Option
      ...
      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Sale Option List</a></li>
        <!--<li><a href="#"><i class="glyphicon glyphicon-list"></i>Add Sale Option</a></li>-->
      </ol>
    </section>
...
<!-- To allow only admin to access the content -->      
    <div class="box box-primary">
		...
		<label class="box-title">Sale Option List</label>
			<a href="<?=$rootPage;?>_add.php?id=" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Sale Option</a>
        ...
        <div class="box-body">
				...
				<div class="col-md-6">					
					<form id="form1" action="<?=$rootPage;?>.php" method="get" class="form" novalidate>
						<div class="form-group">
							<label for="search_word">Sale Option name search key word.</label>
           ...
           ?> 
			...
			<a href="#" name="btnSubmit" class="btn btn-primary pull-right" >Update Sequence No.</a>
