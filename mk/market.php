...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
       ...
       Sales Market
        <small>Sales Market management</small>
      </h1>


      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Sales Market List</a></li>
        <!--<li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Action Sales Market</a></li>-->
      </ol>
    </section>
...
<!-- To allow only admin to access the content -->      
    <div class="box box-primary">
		...
		<label class="box-title">Sales Market List</label>
			<a href="<?=$rootPage;?>_add.php?id=" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Sales Market</a>
				...
				<div class="col-md-6">					
					<form id="form1" action="<?=$rootPage;?>.php" method="get" class="form" novalidate>
						<div class="form-group">
							<label for="search_word">Sales market search key word.</label>
